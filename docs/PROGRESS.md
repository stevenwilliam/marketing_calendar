...
**Last updated:** 2026-09-01 — documents written, no application code yet.
...
|---|---|---|---|
| M0 | Documents | ✅ | This set. **Awaiting Steven's confirmation** — D2–D22 were taken by default, not answered |
...
| M11 | Reports | ⬜ | |
| M12 | Notifications | ⬜ | |
| M13 | Web UI | ⬜ | Design system in `10`, palette measured |
...
| Gate | Result |
|---|---|
| `scripts/contrast.py` | **23/23 pairings measured**, and each verified present in `design.md` |
...
| 2 | Real role names (Q22) | D14 invented plausible ones |
| 3 | Whether a promotion needs a budget field (Q23) | Without it the promo report shows revenue but not margin |
| 4 | The POS export format (Q24) | The importer's column mapping depends on it entirely |
| 5 | Existing brand palette for internal tools (Q28) | `10` proposes a measured neutral one |
